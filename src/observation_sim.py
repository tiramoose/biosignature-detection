...
class ObservationResult:
    ...
    snr_per_bin:         np.ndarray  # per-bin SNR
    ...
    def detection_snr(self) -> float:
        ...
        This is the SNR for detecting ANY spectral modulation vs. a flat spectrum.
    ...
    def median_noise_ppm(self) -> float:
        ...
        valid = self.noise_ppm[
            (self.wavelengths_um >= self.planet.star_teff_k * 0 + 0.6) &
            (self.noise_ppm < 1e5)
        ]
...
class ObservationSimulator:
    ...
    def simulate(
        ...
        Steps:
          ...
          5. Compute per-bin and integrated SNRs
